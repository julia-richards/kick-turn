      ...
      <div>
			...
			<div>
				...
				<textarea
					...
					id="avy_obs"
					onChange={(e) => updateFormValues("avy_observations", e.target.value)}
				></textarea>
			</div>
      <div>
          ...
          placeholder='What snowpack factors concern me and why?'
					onChange={(e) => updateFormValues("snowpack_summary", e.target.value)}
				></textarea>
			</div>
      <div>
        <label>Temp (Nowcast)</label>
        <input type='number' id='temp_now' placeholder='°F' onChange={(e) => updateFormValues("temp_now", `${e.target.value} °F`)}></input>
      </div>
      <div>
        <label>Wind Speed (Nowcast)</label>
        <input type='number' id='wind_sp_now' placeholder='mph' onChange={(e) => updateFormValues("wind_sp_now", `${e.target.value} mph`)}></input>
      </div>
      <div>
        <label>Wind Direction (Nowcast)</label>
        <input type='text' id='wind_dir_now' onChange={(e) => updateFormValues("wind_dir_now", e.target.value)}></input>
      </div>
      <div>
        <label>Sky Cover (Nowcast)</label>
        <input type='text' id='sky_cover_now' onChange={(e) => updateFormValues("sky_cover_now", e.target.value)}></input>
      </div>
      <div>
        <label>Preciptiation (Nowcast)</label>
        <input type='text' id='precip_now' onChange={(e) => updateFormValues("precip_now", e.target.value)}></input>
      </div>
      <div>
        <label>Temp (Forecast)</label>
        <input type='number' id='temp_fore' placeholder='°F' onChange={(e) => updateFormValues("temp_fore", `${e.target.value} °F`)}></input>
      </div>
      <div>
        <label>Wind Speed (Forecast)</label>
        <input type='number' id='wind_sp_fore' placeholder='mph' onChange={(e) => updateFormValues("wind_sp_fore", `${e.target.value} mph`)}></input>
      </div>
      <div>
        <label>Wind Direction (Forecast)</label>
        <input type='text' id='wind_dir_fore' onChange={(e) => updateFormValues("wind_dir_fore", e.target.value)}></input>
      </div>
      <div>
        <label>Sky Cover (Forecast)</label>
        <input type='text' id='sky_cover_fore' onChange={(e) => updateFormValues("sky_cover_fore", e.target.value)}></input>
      </div>
      <div>
        <label>Preciptiation (Forecast)</label>
        <input type='text' id='precip_fore' onChange={(e) => updateFormValues("precip_fore", e.target.value)}></input>
      </div>
      <div>
          ...
          placeholder='What weather factors could affect snowpack today?'
					onChange={(e) => updateFormValues("weather_contribution", e.target.value)}
				></textarea>
			</div>
      <div>
  <label>Trend</label>
  <div>
    <input type="radio" id="improving" name="improving" value="improving" />
    <label for="improving">Improving</label>
  </div>

  <div>
    <input type="radio" id="maintaining" name="maintaining" value="maintaining" />
    <label for="maintaining">Maintaining</label>
  </div>

  <div>
    <input type="radio" id="deteriorating" name="deteriorating" value="deteriorating" />
    <label for="deteriorating">Deteriorating</label>
  </div>
</div>
<div>
          ...
          placeholder='What terrain am I avoiding today and why?'
					onChange={(e) => updateFormValues("terrain_avoiding", e.target.value)}
				></textarea>
        </div>
        <div>
          ...
          placeholder='Synthesize your observations and the avalanche forecast and discuss with your partners.'
					onChange={(e) => updateFormValues("obs_fore_summary", e.target.value)}
				></textarea>
			</div>
      <div>
