    ...
    >
      ...
      <div>
        ...
        <input
          ...
          id="temp_now"
          placeholder="°F"
          onChange={(e) => updateFormValues("temp_now", `${e.target.value} °F`)}
        ></input>
      </div>
      <div>
      ...
      <div>
        <label>Trend</label>
        {["Improving", "Maintaining", "Deteriorating"].map((elOption, elOptionIndex) => {
      ...
      <div>
        ...
        {["Simple", "Challenging", "Complex"].map((elOption, elOptionIndex) => {
          const elFieldId = `${elOptionIndex}`;
          const currentElValues = formValues.ates;
          const isChecked = currentElValues.some((e) => e === elOption);
          const onChange = () =>
